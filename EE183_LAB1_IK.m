...
A = A1*A2*A3*A4;
if abs(x - A(1,4))< 0.01 && abs(y - A(2,4))<0.01&& abs(z-A(3,4))<0.01
    display(acosd(A1(1,1)));
    display(acosd(A2(1,1)));
    display(acosd(A3(1,1)));
    display(acosd(A4(1,1)));
    return
end
